...
/**
 * Offcanvas Login  and User Dashboard
 */
if (!defined('ABSPATH')) {
...
<?php } else { ?>
  <?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
    <div id="customer_login_1">
      ...
      <a href="#" class="pf-register-popup" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-user-register" aria-controls="offcanvas-user-register">New user, click here to create account</a>
      </div>
    </div>
