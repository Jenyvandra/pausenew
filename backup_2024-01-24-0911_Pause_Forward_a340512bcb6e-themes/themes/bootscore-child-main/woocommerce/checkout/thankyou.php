...
<div class="woocommerce-order">
    ...
    if ($order) :
        ...
        <?php else : ?>
            ...
            <ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details woocommerce-message" style="display: none;">



                <li class="woocommerce-order-overview__order order">

                    <?php esc_html_e('Reference number:', 'woocommerce'); ?>
